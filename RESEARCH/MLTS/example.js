    ...
    MobilNet.prototype.loadmodel = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        image = fs.readFileSync(this.image);
                        tfimage = tfnode.node.decodeImage(image);
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        this.predictions.forEach(function (element) {
                            ...
                            if (element.className.search(searchWord) != -1 && element.probability >= _this.percentage) {
                                quantity = quantity + 1;
                                arr.push(element);
                            }
                        });
...
function runtest() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    obj = new MobilNet(path.join("C:/Users/Jc_Ze/OneDrive/Escritorio/LastImages/1.jpg"), "", 0.1);
                    return [4 /*yield*/, obj.getJSON()];
                case 1:
                    result = _a.sent();
                    console.log(result);
                    return [2 /*return*/];
