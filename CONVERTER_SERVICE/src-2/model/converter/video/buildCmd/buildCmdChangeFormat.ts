...
export class BuildCmdChangeFormat extends BuildCmd{
    ...
    returnCmd() {      
        ...
        let footer = new CmdFooter(this.getParameters(), this.outputPath, this.resultName, this.getParameter('outputFormat'));
...
/*
let params = new Parameters({ ratio: '15', scale: '340 x 120', quality: '0', angle: '180', grayScale: 'true', vflip: 'true', hflip: 'true', outputFormat: '.flv'});
