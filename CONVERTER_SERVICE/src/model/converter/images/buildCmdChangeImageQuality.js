...
class BuildCmdChangeImageQuality {
    ...
    returnCommandToChangesQualityImages(executablePathConverterQuality, imagePathChangeQuality, outputPathQuality, qualityImage, outputChangeQuality) {        
        const MAGICK_SPACE = ' '; 
        ...
        const command =
            ...
            MAGICK_SPACE + 
            outputPathQuality +
            path.parse(imagePathChangeQuality).name + "_Change_quality" +
            outputChangeQuality;
        return command;
    }
}
