...
class BuildCmdChangeImagePaint {
    ...
    returnCommandToChangeImagePaint(executablePathPaint, imagePathPaint, PaintImage, outputPathPaint, outputFormatPaint){
        const MAGICK_SPACE = ' '; 
        ...
        const command =
            ...
            MAGICK_SPACE +
            outputPathPaint +
            path.parse(imagePathPaint).name + "_Change_Paint" +
            outputFormatPaint;
        return command;
    }
}
