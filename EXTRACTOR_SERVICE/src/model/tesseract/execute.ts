...
const linkEnglishChino =
	"https://res.cloudinary.com/marcandea/image/upload/v1629733958/samples/text-eng-chin_kxe165.png";
const pathEnglishChino =
	"/home/marc/at14/prog101/projects/AT14-SERVICES/EXTRACTOR_SERVICE/assets/text-eng-chin.png";
...
const extractorCroppedImage: Extractor = new ExtractCroppedImage(
	imageToCropped
);
//
