...
router.post("/", upload.array('Images'), async (req, res)=> {
    ...
    {
        const learning = new analizeCocoSSD(files,searchWord,percentage,secondsToString,algorithm)
    ...
    {
        const learning = new analizeMobilNet(files,searchWord,percentage,secondsToString,algorithm)
        let response = await learning.recognition();
