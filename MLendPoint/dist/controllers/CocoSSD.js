...
var coco_ssd_1 = __importDefault(require("@tensorflow-models/coco-ssd"));
 ...
 *
 */
var CocoSSD = /** @class */ (function (_super) {
    __extends(CocoSSD, _super);
    /**
     ...
     */
    function CocoSSD(image, searchWord, percentage) {
        return _super.call(this, image, searchWord, percentage) || this;
    }
    CocoSSD.prototype.loadModel = function () {
        return __awaiter(this, void 0, void 0, function () {
            var image, processInput, model, predictions;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        image = fs_1.default.readFileSync(this.image);
                        processInput = tfjs_node_1.default.node.decodeImage(image);
                        return [4 /*yield*/, coco_ssd_1.default.load()];
                    case 1:
                        model = _a.sent();
                        return [4 /*yield*/, model.detect(processInput)];
                    case 2:
                        predictions = _a.sent();
    ...
    CocoSSD.prototype.getJSON = function () {
        return __awaiter(this, void 0, void 0, function () {
            var quantity, _a, arr;
            var _this = this;
                    ...
                    case 1:
                        ...
                        this.predictions.forEach(function (element) {
                            ...
                            if (element.class.search(searchWord) != -1 &&
                                element.score >= _this.percentage) {
                                quantity = quantity + 1;
                                arr.push(element);
                            }
                        });
    ...
    CocoSSD.prototype.parse = function (arr) {
        var arrParse = [];
...
//# sourceMappingURL=CocoSSD.js.map