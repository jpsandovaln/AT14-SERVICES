...
const CocoSSD_1 = __importDefault(require("../controllers/CocoSSD"));
const analize_1 = __importDefault(require("./analize"));
const jsonResponse_1 = __importDefault(require("./jsonResponse"));
class analizeCocoSSD extends analize_1.default {
    ...
    recognition() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const image of this.imagePaths) {
                const machineLearning = new CocoSSD_1.default(image.path, this.searchWord, this.percentage);
