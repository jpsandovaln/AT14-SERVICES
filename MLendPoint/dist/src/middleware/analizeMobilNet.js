...
class analizeMobilNet extends module_2.default {
    ...
    recognition() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const image of this.imagePaths) {
                const machineLearning = new module_1.default(image.path, this.searchWord, this.percentage);
                const result = yield machineLearning.getJSON();
                const jsonResponse = new module_3.default();
