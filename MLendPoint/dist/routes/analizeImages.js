...
router.post("/", imageFilter_1.default.array("Images"), function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var files, searchWord, percentage, algorithm, pathImage, secondsToString, learning, response, learning, response;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                pathImage = "http://localhost:8080/images/";
            ...
            case 2:
                ...
                learning = new analizeMobilNet_1.default(files, searchWord, percentage, secondsToString, algorithm);
                return [4 /*yield*/, learning.recognition()];
            case 3:
                response = _a.sent();
                res.send(response);
...
//# sourceMappingURL=analizeImages.js.map