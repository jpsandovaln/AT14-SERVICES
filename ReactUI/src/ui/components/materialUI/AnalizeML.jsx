          ...
          <Grid container spacing={1}>
            ...
            <Grid item xs={7}>              
              <Box component="span" m={6}>                     
                <TextField fullWidth id="outlined-basic" label="Search word" variant="outlined" /*onChange={(e) => setSearchWord(e.target.value)}*/ />                
              </Box>
            </Grid>
            <Grid item xs={7}>
              <Box component="span" m={6}>
                <ChoicePercentage onChange={handleChange} percentage={percentage}/>   
